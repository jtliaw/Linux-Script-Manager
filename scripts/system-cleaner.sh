...
# SUPPORTS: Debian/Ubuntu/Peppermint/Zorin, Fedora/RHEL/CentOS, Arch, openSUSE
# REQUIRES_SUDO: true
...
detect_package_manager() {
    ...
    case "$distro" in
        ubuntu|debian|linuxmint|elementary|zorin|peppermint)
            echo "apt"
            ;;
...
# APT系统清理（Debian/Ubuntu/Peppermint/Zorin）
clean_apt() {
...
main() {
    ...
    print_info "支持: Debian/Ubuntu/Peppermint/Zorin, Fedora/RHEL, Arch, openSUSE"
    echo ""
